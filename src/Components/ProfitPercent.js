...
const ProfitPercent = () => {
  const [options, setOptions] = useState({
      ...
      series: [
        ...
        {
          name: 'Minimum Profit',
          data: [6100, 6165, 6235, 6008, 5926, 6298],
          color: '#7E3AF2',
        },
      ],
      legend: {
    ...
    useEffect(() => {
      ...
      if (document.getElementById("area-chart") && typeof ApexCharts !== 'undefined') {
        const chart = new ApexCharts(document.getElementById("area-chart"), updatedOptions);
        chart.render();
      }
    }, [options]); // Empty dependency array ensures the useEffect runs only once on component mount
  ...
  <div class="flex justify-between mb-5">
    <div class="grid gap-4 grid-cols-2">
      <div>
        <h5 class="inline-flex items-center text-gray-500 dark:text-gray-400 leading-none font-normal mb-2">Maximum
        ...
        <p class="text-gray-900 dark:text-white text-2xl leading-none font-bold">38.7k</p>
      </div>
      <div>
        <h5 class="inline-flex items-center text-gray-500 dark:text-gray-400 leading-none font-normal mb-2">Minimum 
        ...
        <p class="text-gray-900 dark:text-white text-2xl leading-none font-bold">36.3k</p>
      </div>
    </div>
    <div>
    ...
    <div class="pt-5">      
      <a href="#" class="px-5 py-2.5 text-sm font-medium text-white inline-flex items-center bg-indigo-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
